        ...
        columns: [
            ...
            { 
                ...
                render: function(data, type, row) {
                    let badgeClass = '';
                    const statusLow = data.toLowerCase();
                    // Check 'tidak sesuai' and 'kurang' BEFORE 'sesuai' since 'tidak sesuai' contains 'sesuai'
                    if (statusLow.includes('tidak sesuai') || statusLow.includes('kurang')) badgeClass = 'status-belum-lengkap';
                    else if (statusLow.includes('sesuai')) badgeClass = 'status-sesuai';
                    else if (statusLow.includes('proses') || statusLow.includes('persetujuan')) badgeClass = 'status-belum-lengkap';
                    else badgeClass = 'status-belum-upload';
