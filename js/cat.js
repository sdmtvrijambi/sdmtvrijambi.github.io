...
class WalkingCat {
  constructor(options = {}) {
    ...
    this.emotes = options.emotes || ['Meow~ 🐾', 'Meow Meow ✨', 'Purr~ ❤️', 'Meow!', '🐾'];
  ...
  function initWalkingCats() {
    walkingCats = [
      ...
      new WalkingCat({
        ...
        emotes: ['🐾 Meow~', 'Meow Meow ✨', '(=^･ω･^=)', 'Purr~ ❤️', 'Meow! 🐾'],
        walkPhase: 0
      }),
      // Cat 2: Princess Luna (Snow White Anggora with Sapphire Eyes)
      new WalkingCat({
        name: 'Luna',
        x: width * 0.8,
        scale: 1.12,
        ...
        emotes: ['✨ Meow~', 'Meow Meow 🌸', 'Purr~ ❤️', '🐾', 'Meow! ✨'],
      ...
      new WalkingCat({
        ...
        emotes: ['Meow! 🐾', 'Meow Meow ✨', 'Purr~ ❤️', 'Nyaa! 🐾'],
